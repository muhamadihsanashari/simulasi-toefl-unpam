...
public class TestingStructureSectionActivity extends AppCompatActivity {
    ...
    private static final String KEY_MILLIST_LEFT = "keyMillisLeft";
...
//        DATABSE HELPER
        ...
        if (savedInstanceState == null) {
            ...
            timeLeftInMillis = savedInstanceState.getLong(KEY_MILLIST_LEFT);
...
//            COUNTDOWN TIMER
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putLong(KEY_MILLIST_LEFT, timeLeftInMillis);
